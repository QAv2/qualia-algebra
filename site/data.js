...
var QA_NODES = [
  ...
  },
  {
    ...
    "description": "What science studies — the complete physical universe. Stable because many observers mutually phase-lock. Predictable because high λ constrains possibilities.\n\nContains TWO simultaneous reciprocal aspects (RS2 integration):\n• Material Sector: Observable [1,x,y,z] — perceived external reality\n• Cosmic Sector: [1,1/x,1/y,1/z] — everything NOT in observer's personal focus\n\n[1,x,y,z] ⊙ [1,1/x,1/y,1/z] = [1,1,1,1] — component-wise product ⊙, not the Hamilton quaternion product (v3 repair). In log coordinates: Material + Cosmic = 0 — the cosmic sector is your point-reflection through consensus. Consensus is the mirror.\n\n🟢 Intersubjective reality is standard scientific assumption\n🟠 QA reframes as emergent from observer phase-locking\n🟡 RS2 convergence: reciprocal sectors map to QA formalism"
  },
  {
    "id": "qa-logchart",
    "ring": "spaces",
    "label": "The Log-Space Chart",
    "subtitle": "v3 — ξ = ln(content); Consensus Is the Mirror",
    "description": "NEW IN v3 (ratified 2026-07-19). For manifest states [1,x,y,z] with positive content, take ξ = (ln x, ln y, ln z). Component-wise multiplication becomes vector addition, and five things fall out exactly:\n\n• Reciprocity is genuine algebra: ξ_Material + ξ_Cosmic = 0 (Larson's s/t · t/s = 1, literally, in log-measure)\n• Consensus [1,1,1,1] maps to the ORIGIN\n• The cosmic map is point-reflection ξ ↦ −ξ: the cosmic sector is your mirror image, and consensus is the mirror\n• Neti Neti is straight-line motion — every release step the same constant translation along the negative diagonal\n• The witness [1,0,0,0] is an ideal point at INFINITE log-distance: approachable, never arrived at in finite steps — the last step is not a step\n\nCorollary: only the balanced observer (x = y = z) passes exactly through consensus on the way home; imbalance in log-units is the miss-distance.\n\nCaveat, held in plain view: logarithms need positive content; signed content would need orthant labels (speculative) or complexification.\n\n🟢 Exact algebra given QA's definitions (Proposition 0)\n🟠 Repairs the former quaternion-notation identity (scalar −2 refutation)\n🟡 Mended Mirror convergence recorded as provenance, not evidence\n📄 Full note: papers/QA_v3_Log_Space_Chart.md"
  },
  {
    "id": "qa-potential",
    "ring": "spaces",
